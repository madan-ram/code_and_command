...
def data_augmentation(orignial_img, size_factor_up=1.25, size_factor_down=0.5):
	result = []
	...
	img_30 = rotate(orignial_img, np.random.randint(10, high=30))
	...
	img_45 = rotate(orignial_img, np.random.randint(30, high=45))
	...
	img_m30 = rotate(orignial_img, np.random.randint(-30, high=-10))
	...
	img_m45 = rotate(orignial_img, np.random.randint(-45, high=-30))
